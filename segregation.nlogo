...
;; Schelling's model of spatial segregation is a milestone in the study of emergent
;; global phenomena based on local social interactions (Schelling 1969;
;; Schelling 1971; Schelling 1978). Schelling's model illustrates how clearly
;; distinctive patterns of spatial segregation (e.g. ghettos) can emerge even
...
to update-happiness
  ...
  set happy? similar-nbrs >= (%-similar-wanted * total-nbrs / 100)
end
...
to do-plots-&-statistics
  ...
  set-current-plot "Percentage Unhappy Agents"
  plot %-unhappy-agents

  set-current-plot "Avg Percentage Similar Nbrs"
  plot avg-%-similar
